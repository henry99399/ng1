...
/**
 * Created by shiaihua on 16/5/16.
 */
public class ValidCodeUtil {
    ...
    public static void getValidCode(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
