...
public class AudioCatBean {
    ...
    private String audio_cat_name;   //分类名称

    private String audio_cat_path;   //分类路径
    ...
    private List<AudioCatBean> children;
    ...
    public List<AudioCatBean> getChildren() {
        return children;
    }

    public void setChildren(List<AudioCatBean> children) {
