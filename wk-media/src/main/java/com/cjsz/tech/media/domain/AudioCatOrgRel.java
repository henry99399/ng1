 ...
 */
@Entity
@Table(name = "audio_cat_org_rel")
public class AudioCatOrgRel implements Serializable{

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long rel_id;//音频分类机构关系
    ...
    public AudioCatOrgRel() {
    }

    public AudioCatOrgRel(Long org_id, Long audio_cat_id, Long order_weight, Integer is_show, Long source_id, Integer source_type, Date create_time, Date update_time, Integer is_delete) {
        this.org_id = org_id;
