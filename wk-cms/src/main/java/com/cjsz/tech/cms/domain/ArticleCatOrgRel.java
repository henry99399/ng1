 ...
 */
@Entity
@Table(name = "article_cat_org_rel")
public class ArticleCatOrgRel implements Serializable {
    ...
    private Long article_cat_id;//资讯分类Id
    ...
    public ArticleCatOrgRel() {
    }

    public ArticleCatOrgRel(Long org_id, Long article_cat_id, Long order_weight, Integer is_show, Long source_id, Integer source_type, Date create_time, Date update_time, Integer is_delete) {
        this.org_id = org_id;
