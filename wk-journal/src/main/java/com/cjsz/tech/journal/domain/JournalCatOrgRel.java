 ...
 */
@Entity
@Table(name = "journal_cat_org_rel")
public class JournalCatOrgRel implements Serializable {
    ...
    public JournalCatOrgRel() {
    }

    public JournalCatOrgRel(Long org_id, Long journal_cat_id, Long order_weight, Integer is_show, Long source_id, Integer source_type, Date create_time, Date update_time, Integer is_delete) {
        this.org_id = org_id;
