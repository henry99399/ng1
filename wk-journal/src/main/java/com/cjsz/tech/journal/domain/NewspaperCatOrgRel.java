 ...
 */
@Entity
@Table(name = "newspaper_cat_org_rel")
public class NewspaperCatOrgRel implements Serializable {
    ...
    public NewspaperCatOrgRel() {
    }

    public NewspaperCatOrgRel(Long org_id, Long newspaper_cat_id, Long order_weight, Integer is_show, Long source_id, Integer source_type, Date create_time, Date update_time, Integer is_delete) {
        this.org_id = org_id;
