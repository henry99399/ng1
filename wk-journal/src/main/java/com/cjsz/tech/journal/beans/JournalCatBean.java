...
public class JournalCatBean {
    ...
    private List<JournalCatBean> children;
    ...
    public List<JournalCatBean> getChildren() {
        return children;
    }

    public void setChildren(List<JournalCatBean> children) {
