 ...
 */
@Entity
@Table(name = "periodical_cat_org_rel")
public class PeriodicalCatOrgRel implements Serializable {
    ...
    public PeriodicalCatOrgRel(){

    }

    public PeriodicalCatOrgRel(Long org_id, Long periodical_cat_id, Long order_weight,
                               Integer is_show, Date create_time, Date update_time, Integer is_delete) {
        this.org_id = org_id;
