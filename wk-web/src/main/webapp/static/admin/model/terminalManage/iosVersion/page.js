var startStop;
myApp.controller('iosVersionController', function ($rootScope, $scope, services, $sce, $stateParams) {
    $scope.services = services;
    //版本列表
    services["_edition_Data"] = function (param) {
        return $rootScope.serverAction(ctxPath + '/admin/appVersionIos/pageList', param, "POST");
    }
    //版本新增-修改
    services["_edition_Update"] = function (param) {
        return $rootScope.serverAction(ctxPath + '/admin/appVersionIos/update_appVersion', param, "POST");
    }
    //版本删除
    services["_edition_Del"] = function (param) {
        return $rootScope.serverAction(ctxPath + '/admin/appVersionIos/delete_appVersions', param, "POST");
    }
    //当前使用版本
    services["_edition_enabled"] = function (param) {
        return $rootScope.serverAction(ctxPath + '/admin/appVersionIos/updateEnabled', param, "POST");
    }
    ...
    $scope.tableControl = {
        config: {
            ...
            columns: [
                ...
                {field: 'publish_url', title: "IPA", align: 'left'},
                {
