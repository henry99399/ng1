...
public class ImageCompressUtil {
	...
	public static byte[] saveMinPhoto(String srcURL, double comBase,
		...
		tag.getGraphics().drawImage(src, 0, 0, deskWidth, deskHeight, null); //绘制缩小后的图
//		FileOutputStream deskImage = new FileOutputStream(deskURL); //输出到文件流
		ByteArrayOutputStream deskImage=new ByteArrayOutputStream(1024);
		JPEGImageEncoder encoder = JPEGCodec.createJPEGEncoder(deskImage);
		encoder.encode(tag); //近JPEG编码
...
//		byte[] bytes = ImageCompressUtil.saveMinPhoto("C:/Users/Administrator/Desktop/11.png", 300, 1);
//		ByteArrayInputStream bis =new ByteArrayInputStream(bytes);
//		FileOutputStream fileOutputStream=new FileOutputStream("C:\\Users\\Administrator\\Desktop\\1.jpg");
